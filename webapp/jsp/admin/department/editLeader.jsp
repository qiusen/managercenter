...
<body>
<form name="departmentForm" id="departmentForm" method="post" action="departmentAction!editSaveLeader.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    ...
    <tr>
    	...
    	<input type="radio" id="leaderEmail" name="leaderEmail" value="${manager.email}" <c:if test="${requestScope.department.leaderEmail == manager.email}">checked="checked"</c:if>/>${manager.nickname} ${manager.email}&nbsp;&nbsp;
    	</c:forEach>
    	</td>
    </tr>
    <tr>
