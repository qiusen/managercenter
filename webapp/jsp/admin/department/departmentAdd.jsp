...
<body>
<form name="departmentForm" id="departmentForm" method="post" action="departmentAction!addSave.${actionExt}" onsubmit="return checkForm();">
<input name="department.superId" type="hidden" id="department.superId" />
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <tr>
    	<td align="right" class="l-table-edit-td">名称：</td>
    	<td align="left" class="l-table-edit-td"><input name="department.name" type="text" id="department.name" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">代号：</td>
    	<td align="left" class="l-table-edit-td"><input name="department.code" type="text" id="department.code" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
