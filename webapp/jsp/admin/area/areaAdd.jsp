...
<body onload="changeCityList();">
<form name="areaForm" id="areaForm" method="post" action="areaAction!addSave.${actionExt}" onsubmit="return checkForm();">
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <tr>
    	<td align="right" class="l-table-edit-td">编号：</td>
    	<td align="left" class="l-table-edit-td"><input name="area.code" type="text" id="area.code" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">名称：</td>
    	<td align="left" class="l-table-edit-td"><input name="area.name" type="text" id="area.name" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
